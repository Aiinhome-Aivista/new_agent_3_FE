...
const LoginPage = () => {
  ...
  return (
    <div className="min-h-screen bg-light-background font-sans text-primary-text flex flex-col justify-center py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="absolute top-40 -right-20 w-72 h-72 bg-orange-border rounded-full mix-blend-multiply filter blur-3xl opacity-35 animate-blob animation-delay-2000" />
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md z-10">
        ...
        <h2 className="text-center text-3xl font-extrabold text-primary-text tracking-tight">
          Welcome back
        </h2>
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md z-10">
          ...
          <form className="space-y-5" onSubmit={handleSubmit}>
            ...
            <div className="pt-2">
              <button
                type="submit"
                disabled={loading}
                className="w-full flex justify-center items-center py-3 px-4 border border-transparent rounded-xl shadow-lg shadow-orange-border text-sm font-bold text-white bg-button-orange hover:bg-hover-orange focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-orange transition-all duration-150 disabled:opacity-50"
              >
                {loading ? (
        ...
        {/* <div className="mt-6 bg-light-background border border-light-border rounded-2xl shadow-xl shadow-light-border/50 p-5">
          <div className="flex items-center space-x-2 mb-3">
            ...
            <h4 className="text-xs font-bold text-secondary-text tracking-wider uppercase">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            {DEMO_USERS.map((user) => (
              ...
              >
                ...
                <div className="text-xxs text-secondary-text font-medium leading-normal mt-0.5">
                  {user.role}
                </div>
              </button>
            ))}
